...
fetch('albums.json')
  ...
  .then(albums => {
    ...
    // disappear previous pause button
    let prevPauseButton;
  ...
  `;
    ...
    //search
    const albumContainer = document.getElementsByClassName('albums-container-albums')
...
`;
    ...
    const filterAlbums = (query) => {
      ...
      albumElements.forEach((albumElement) => {
        const albumTitle = albumElement.innerText.toLowerCase();
